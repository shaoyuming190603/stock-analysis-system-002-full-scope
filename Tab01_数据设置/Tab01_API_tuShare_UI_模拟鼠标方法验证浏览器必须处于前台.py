...
# 尝试导入 win32gui，用于激活窗口；若失败则回退使用 uiautomation 的 SetActive
try:
    import win32gui
    HAS_WIN32GUI = True
except ImportError:
